  ...
  return (
    <section className="section">
      ...
      <div className="content">
        ...
        <p>
          Hello, my name is Shahnoor Rasheed, I am a professional FullStack MERN developer with an experience of more than 3 years in web designing. I am based in London, United Kingdom. I am working on projects remotely on for clients all over the world. I have a diverse set of skills, ranging from design to HTML + CSS + JavaScript.
        </p><br />

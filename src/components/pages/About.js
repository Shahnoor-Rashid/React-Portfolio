  ...
  return (
    <section className="section">
      ...
      <div className="content">
        ...
        <p>
          Hello, my name is Shahnoor Rashid, I am a professional FullStack MERN developer with an experience of more than 3 years in web designing. I am based in Birmingham, United Kingdom. I am working on projects remotely on for clients all over the world. I have a diverse set of skills, ranging from design to HTML, CSS and JavaScript.
        </p><br />
